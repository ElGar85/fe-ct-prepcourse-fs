...
function incrementarPorUno(array) {
   ...
   for(var i = 0; i < array.length; i++){
      var sumaIncre = array[i] + 1;
      arrayIncremento.push(sumaIncre);
...
function empiezaConNueve(num) {
   ...
   // Tu código:
   var parametro = String(num);
   if(parametro[0] === '9') return true;
   return false;
}
...
function todosIguales(array) {
   ...
   // Tu código:
   let primerPos = array[0];
   for(let i = 1; i < array.length; i++){
      if(primerPos === array[i]){
         return true;
      }
      return false;
   }
